...
namespace sf
{
    ...
    public:
        ...
        static void PublishIMU(ros::Publisher& pub, IMU* imu, ros::Publisher& pub_heading);
        ...
        static void PublishLaserMEMSPCL(ros::Publisher& pub, LaserMEMS* mb);
        ...
        static void PublishLiDAR360(ros::Publisher& pub, LiDAR360* lidar);
        static void PublishLiDAR360PCL(ros::Publisher& pub, LiDAR360* lidar);
